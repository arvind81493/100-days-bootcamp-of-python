...
while game_should_continue:
    ...
    print(f" compare A: {account_name},{account_descr},from {account_country}")
    print(vs)
    account_name=account_b["name"]
    account_descr=account_b["description"]
    account_country=account_b["country"]
    print(f" Against B: {account_name},{account_descr},from {account_country}")
